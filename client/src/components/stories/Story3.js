...
const Story3 = () =>{
    return(
        <div>
            ...
            <p>ONCE upon a time there were four little Rabbits, and their names were— Flopsy, Mopsy, Cotton-tail, and Peter.

They lived with their Mother in a sand-bank, underneath the root of a very big fir tree.

"NOW, my dears," said old Mrs. Rabbit one morning, "you may go into the fields or down the lane, but don't go into Mr. McGregor's garden: your Father had an accident there; he was put in a pie by Mrs. McGregor."</p>
<p>"NOW run along, and don't get into mischief. I am going out."
...
FIRST he ate some lettuces and some French beans; and then he ate some radishes;</p>

<p>AND then, feeling rather sick, he went to look for some parsley.
