...
const Story2 = () =>{
    return(
        <div>
            <h1>Cousin Tribulation's Story</h1>
            <p>Dear Merrys:--As a subject appropriate to the season, I want to tell you about a New Year's breakfast which I had when I was a little girl. What do you think it was? A slice of dry bread and an apple. This is how it happened, and it is a true story, every word.</p>
            <p>As we came down to breakfast that morning, with very shiny faces and spandy clean aprons, we found father alone in the dining-room.
...
"I can carry the lassy pot," said little May, proudly giving the thing she loved best.</p>
<p>"And I shall take all the porridge," I burst in, heartily ashamed of my first feeling.
